...
### TASK-039P1D exact fidelity audit

- Verified the local read-only checkout at the exact pinned commit. No fetch,
  source copy, model training, or data access occurred.
- Exact upstream file identities:

| Path | Git blob SHA | File SHA-256 |
|---|---|---|
...
- MIT license blob:
  `956d782cc7291c801373a8d256135b497597e539`; file SHA-256:
  `ffdad180c52921c5fb96b388ac08a4b5fa9e8eed6fd531969726219877a70b33`.
- Fidelity conclusion: current deterministic and Torch/PyG trainers are
  synthetic smoke-only. `gdn/masked.py` is a project-owned extraction
  component, not a complete GDN model. Only a future
  `upstream_aligned_validated` backend may be called GDN in an RQ1 arm.
