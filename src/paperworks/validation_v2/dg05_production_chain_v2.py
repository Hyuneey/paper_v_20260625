...
def build_production_release_manifest_v5(
    *, repository_root: Path, predecessor_v4_manifest_path: Path,
    ...
    if executable_version not in {"DG05_EXECUTABLE_V5", "DG05_EXECUTABLE_V6", "DG05_EXECUTABLE_V7", "DG05_EXECUTABLE_V8", "DG05_EXECUTABLE_V9", "DG05_EXECUTABLE_V10"}:
        raise DG05ProductionChainV2Error("SUPPORTED_EXECUTABLE_VERSION_REQUIRED")
    if executable_version in {"DG05_EXECUTABLE_V6", "DG05_EXECUTABLE_V7", "DG05_EXECUTABLE_V8", "DG05_EXECUTABLE_V9", "DG05_EXECUTABLE_V10"}:
...
def initialize_production_release_v5(
    *, release_manifest_path: Path, repository_root: Path,
    ...
    if (
        ...
        or expected_executable_version not in {"DG05_EXECUTABLE_V5", "DG05_EXECUTABLE_V6", "DG05_EXECUTABLE_V7", "DG05_EXECUTABLE_V8", "DG05_EXECUTABLE_V9", "DG05_EXECUTABLE_V10"}
