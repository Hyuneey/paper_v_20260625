...
STAGING = ROOT / "research_control_center/validation_v2/dg05_v11_release_staging_rerun3"
...
def main() -> None:
    ...
    parity=self_hashed({"schema":"dg05_v11_kernel_parity_receipt_v1","status":"PASS","frozen_v5_kernel_hash":manifest["frozen_kernel"]["source_byte_hash"],"planned_cells":fresh["planned_cells"],"actual_v5_cells":fresh["actual_v5_cells"],"fallback_cells":0,"heldout_cells":0})
    ...
    final=self_hashed({"schema":"dg05_executable_v11_candidate_manifest_v1","designation":"DG05_EXECUTABLE_V11","status":"CANDIDATE_AWAITING_EXACT_USER_APPROVAL","approval_status":"NOT_APPROVED","execution_binding_hash":manifest["self_hash"],"implementation_source_commit":head,"authority_hashes":manifest["authority_hashes"],"implementation_authorities":manifest["implementation_authorities"],"frozen_kernel":manifest["frozen_kernel"],"qualification_evidence":{"root_replay":root["self_hash"],"fresh_process":fresh["self_hash"],"bridge_rehearsal":bridge["self_hash"],"schedule_envelope":schedule["self_hash"],"structural_result":result["self_hash"],"kernel_parity":parity["self_hash"],"independent_qa":qa["self_hash"],"adversarial_qa":adversarial["self_hash"],"privacy_qa":privacy["self_hash"]},"heldout_predictions_observed":0,"heldout_metrics_observed":0,"alternate_scientific_route":False,"synthetic_fallback_authorized":False,"user_approved_release_hash":None})
