...
class RootReplayV3Tests(unittest.TestCase):
    def _fixture(self, root: Path, timestamps=None):
        ...
        projection, timestamp = project_attack_feature_file_v1(
            ...
            panel_authority=allowlist, file_id="F1", adapter_implementation_hash=H, source_commit=G)
        ...
        state_before = self_hashed({"schema": "dg05_production_chain_state_v4", "state": "GLOBAL_PREDICTION_FROZEN_LABEL_LOCKED",
                                    "release_manifest_hash": H, "global_prediction_freeze_hash": freeze["self_hash"],
        ...
        lease = self_hashed({
            ...
            "executable_manifest_hash": H, "resource_policy_hash": policy["self_hash"],
        ...
        request = {
            ...
            "executable_manifest_hash": H, "approved_source_ids": [source_id],
        ...
        output = self_hashed({
            ...
            "predecessor_state_hash": issued["self_hash"], "executable_manifest_hash": H,
            "authority_mode": "SYNTHETIC_REHEARSAL", "resource_policy_hash": policy["self_hash"],
            "scenario_adapter_implementation_hash": H,
        ...
        invocation = self_hashed({
            "schema": "dg05_fresh_process_custodian_invocation_v1", "launcher_byte_hash": H,
            ...
            "resource_policy_hash": policy["self_hash"], "custodian_implementation_hash": H,
            "predecessor_state_hash": issued["self_hash"], "global_freeze_hash": freeze["self_hash"],
            "release_manifest_hash": H, "custodian_pid": 2, "custodian_parent_pid": 1,
        ...
        paths = RootToResultReplayPathsV3(
            intermediate, physical_path, {"F1": raw_path}, {"F1": projection_doc_path},
