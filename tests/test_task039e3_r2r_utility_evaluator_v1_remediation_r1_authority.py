...
EXPECTED_R1_IMPLEMENTATION_IDENTITY = (
...
class EvaluatorAuthorityCustodyR1Tests(unittest.TestCase):
    ...
    def test_factory_issued_bundle_and_r1_implementation_pass(self) -> None:
        self.assertEqual(
        ...
        self.assertEqual(evaluator_v1.UTILITY_EVALUATOR_CONTROL_REVISION, "R1")
