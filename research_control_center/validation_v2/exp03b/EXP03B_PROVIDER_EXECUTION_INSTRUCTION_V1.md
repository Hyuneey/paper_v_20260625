...
현재 실행 금지: DG-03B USER_DECISION_REQUIRED. exact release commit은 EXP03B_RELEASE_RECEIPT_V1.json의 implementation_commit 및 preparation_commit을 재생합니다. source/hash closure는 EXP03B_FINAL_PREPARATION_FREEZE_V2.json입니다.
