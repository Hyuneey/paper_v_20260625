# DG-XVER-PROVIDER — external T2 execution decision
...
- Frozen candidate N: 29; canonical GDN context: 36 / 37 (SCHEMA_BOUND_PARTIAL_CONTEXT_REPLICATION).
...
- Auxiliary Event states: {'AVAILABLE': 415, 'NOT_IN_LEARNED_GRAPH': 1280, 'NO_VALIDATION_EVENT': 45}. Analysis-only, not fused or exposed.
- T0: 13 retained Rules / 12 pairs; hash `94f130408361e6b4a8051ed4a72a0ad385e90cb3212e2bf0d27af300f481503f`.
- T2 provider / retrieval packs: 29 each, exact byte hashes bound in token profile.
- Calls: 29 if all first proposals accepted; maximum 87. No probabilistic expected-call claim.
- Initial local tokens min/median/max: 1556 / 1837 / 1923.
- Initial total: 52636; maximal-shape repair: 4446; profiled maximal-shape schedule: 299226.
- Hard input/output/total caps: 1633280 / 178176 / 1811456.
- Prospective standard-price ceiling: USD 2.03; NOT actual billing.
- Budget authority hash: `42de5ca54b478874d53a756a7ed16eba67957abc1a57413cc1b6119a33877ebb`.
## HAI 21.03

- Frozen candidate N: 29; canonical GDN context: 30 / 37 (SCHEMA_BOUND_PARTIAL_CONTEXT_REPLICATION).
- Six split-pure scientific runs PASS; train1/train2 seeds 11/23/37, no best seed.
- GLOBAL: five horizon rows per pair, provider train1 / retrieval train2 only.
- Auxiliary Event states: {'AVAILABLE': 300, 'NOT_IN_LEARNED_GRAPH': 1370, 'NO_VALIDATION_EVENT': 70}. Analysis-only, not fused or exposed.
- T0: 7 retained Rules / 5 pairs; hash `f9cad3c00c422614012b2147f3c21951632f8738ce2d8f9f1108d61ae69d6ef3`.
- T2 provider / retrieval packs: 29 each, exact byte hashes bound in token profile.
- Calls: 29 if all first proposals accepted; maximum 87. No probabilistic expected-call claim.
- Initial local tokens min/median/max: 1562 / 1848 / 1916.
- Initial total: 51850; maximal-shape repair: 4436; profiled maximal-shape schedule: 293772.
- Hard input/output/total caps: 1633280 / 178176 / 1811456.
- Prospective standard-price ceiling: USD 2.03; NOT actual billing.
- Budget authority hash: `51bef64337cc5a4d965945b09b39d4e03d84ef56414a479e9436b728bb345313`.
