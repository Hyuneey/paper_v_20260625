...
def _render_dg04(vm: Mapping[str, Any]) -> str:
    ...
    <p>Stage B: BLOCKED_PENDING_HAI_XVER_NORMAL_PREP. DEC-026 승인 후 정상9개 파일 positive allowlist projection/custody PASS. Label 이름은 schema-only, excluded 값 decode·검증·사용 0, 공격/provider 0.</p>
    <p>HAI22 24 / HAI21 22 exact P1 역할 feature, portable META 20 / 19, STAT20 / 20, candidate union29 / 29. 외부 GDN 학습·T0·T2 packs 미실행. DG-03C exact budget 미정; 현재 gate명 DG-XVER-PROVIDER.</p>
    ...
    <a href="../validation_v2/dg04_xver_prep/CURRENT_PREPARATION_STATUS_V2.md">정상 custody 복원과 후속 준비</a></section>'''
