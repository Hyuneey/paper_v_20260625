...
- **ID:** USER-V2-004
  **우선순위:** 높음 (HIGH)
  **할 일:** DG-03C — 외부 T2 provider 결정 준비
  **사용자 확인이 필요한 이유:** DG-04는 DEC-025로 승인됨; Stage B 정확한 준비·예산 필요
  **연결 문서:** research_control_center/validation_v2/dg04_xver_prep/FINAL_TITLE_CLAIMS_AND_RQ_V1.md
  **상태:** 미결정
## 필수 향후 Gate
