...
- **ID:** USER-V2-004
  **우선순위:** 높음 (HIGH)
  **할 일:** DG-03B_REVISED — EXP-03B 신규 provider 예산·전송 승인
  **사용자 확인이 필요한 이유:** 정상 evidence 준비 완료;최대609회·USD11.03. DG-04는 EXP-03B 결과 뒤로 연기합니다.
  **연결 문서:** research_control_center/validation_v2/exp03b/DG03B_PROVIDER_DECISION_BRIEF_V2.md
  **상태:** 미결정
## 필수 향후 Gate
