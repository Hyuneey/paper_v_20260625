...
- **ID:** USER-V2-004
  **우선순위:** 높음 (HIGH)
  **할 일:** 정상 schema-only projection 접근 범위 확인
  **사용자 확인이 필요한 이유:** 자동심사가 embedded label 열 이름까지 label 접근으로 해석하여 차단
  **연결 문서:** research_control_center/validation_v2/dg04_xver_prep/XVER_NORMAL_CUSTODY_BLOCKER_V1.json
  **상태:** 미결정
## 필수 향후 Gate
