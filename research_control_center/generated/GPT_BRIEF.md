...
**EVALUATION_SCOPE_EXPANSION** — DG-04 / DEC-025와 Stage A는 불변입니다. DG-03B_REVISED 승인 후 동결된 EXP-03B에서 T2는 matched-budget T1-B 대비 이점이 있지만 T0보다 우수하지 않았습니다. T0 22 Rules, T2 Repeat 1 21 Rules, V2A39는 별도 authority입니다.
...
- 추가 정상-only GDN/evidence 준비는 HAI-XVER-NORMAL-PREP-001
- DG-XVER-PROVIDER: exact evidence·예산 후 별도 승인
- DG05 metric 선택/공격 접근과 DG06 제출 별도 승인
