...
| EXP-H22-XVER | 구현 완료·미실행 | NORMAL_PREPARATION_COMPLETE_ATTACK_EVALUATION_NOT_EXECUTED |
| EXP-H21-XVER | 구현 완료·미실행 | NORMAL_PREPARATION_COMPLETE_ATTACK_EVALUATION_NOT_EXECUTED |
...
| CLAIM-N | 미검증 (UNVALIDATED) | External normal-only T0 instantiation and T2 evidence preparation are complete;new attack panels are not executed. |
