...
제외됐다. 따라서 D1 권장 명칭은 **COMMON-42 Verified Relational Rule-only**이다.
...
다음 task는 **CUSTODY-RESTORE — Configure approved HAI_NORMAL_ROOT and rerun train1~4 single custody issuer**이다.
