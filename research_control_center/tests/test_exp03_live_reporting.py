...
class LiveReportingTests(unittest.TestCase):
    ...
    def test_current_state_requires_dg04_and_preserves_other_gates(self):
        ...
        self.assertEqual("DEFERRED_UNTIL_EXP03B", program["decision_gates"]["DG-04"])
        self.assertEqual("USER_DECISION_REQUIRED", program["decision_gates"]["DG-03B"])
        self.assertEqual("PREPARED_DG03B_PENDING",state['exp03b_preparation']['status'])
