...
class Arch005VerifierCommon42Tests(unittest.TestCase):
    ...
    def test_state_and_generated_summary(self):
        ...
        self.assertIn(state["last_completed_task"], {"ARCH-005", "ARCH-006", "ARCH-007", "ARCH-008"})
        self.assertTrue(state["exact_next_task"].startswith(("ARCH-006", "ARCH-007", "ARCH-008", "ARCH-009")))
