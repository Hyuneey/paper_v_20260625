...
class Arch005VerifierCommon42Tests(unittest.TestCase):
    ...
    def test_state_and_generated_summary(self):
        ...
        self.assertTrue(state["last_completed_task"] in {"ARCH-005", "ARCH-006", "ARCH-007", "ARCH-008", "ARCH-009", "ARCH-010", "GAP-000", "ARCH-011"} or state["last_completed_task"].startswith(("GAP-FIX-001", "GAP-FIX-002", "V2-PROTOCOL-001")))
        self.assertTrue(state["exact_next_task"].startswith(("ARCH-006", "ARCH-007", "ARCH-008", "ARCH-009", "ARCH-010", "GAP-000", "ARCH-011", "GAP-FIX-001", "GAP-FIX-002", "V2-PROTOCOL-001", "GAP-FIX-METRIC-001")))
