...
class ARCH004RuleConstructionTests(unittest.TestCase):
    ...
    def test_current_state_and_generated_view(self) -> None:
        ...
        self.assertIn(state["last_completed_task"], {"ARCH-004", "ARCH-005", "ARCH-006", "ARCH-007", "ARCH-008", "ARCH-009"})
        self.assertTrue(state["exact_next_task"].startswith(("ARCH-005", "ARCH-006", "ARCH-007", "ARCH-008", "ARCH-009", "ARCH-010")))
