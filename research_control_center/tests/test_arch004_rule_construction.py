...
class ARCH004RuleConstructionTests(unittest.TestCase):
    ...
    def test_current_state_and_generated_view(self) -> None:
        ...
        self.assertTrue(state["last_completed_task"] in {"ARCH-004", "ARCH-005", "ARCH-006", "ARCH-007", "ARCH-008", "ARCH-009", "ARCH-010", "GAP-000", "ARCH-011"} or state["last_completed_task"].startswith(("GAP-FIX-001", "GAP-FIX-002", "V2-PROTOCOL-001", "GAP-FIX-METRIC-001", "FRESH-MACHINE-SYNTHETIC", "VALIDATION-V2-RESUME-001", "V2-HAI", "V2-DUALTRACK-002")))
