...
class ValidationV2ProgramTests(unittest.TestCase):
    def test_program_state_preserves_v1_and_held_out_boundary(self) -> None:
        ...
        self.assertEqual(state['program_status'],'BLOCKED_GDN_METHOD_CHANGE_REQUIRED')
        ...
        self.assertEqual(state['decision_gates']['DG-03C'],'NOT_READY_EVENT_EVIDENCE_BINDING_REQUIRED')
        self.assertEqual(state['exact_next_task'],'HAI-XVER-NORMAL-PREP-001')
