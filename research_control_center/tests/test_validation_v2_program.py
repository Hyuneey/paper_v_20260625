...
class ValidationV2ProgramTests(unittest.TestCase):
    def test_program_state_preserves_v1_and_held_out_boundary(self) -> None:
        ...
        self.assertEqual(state['program_status'],'BLOCKED_PENDING_HAI_XVER_NORMAL_PREP')
        ...
        self.assertEqual(state['decision_gates']['DG-03C'],'NOT_READY_PENDING_HAI_XVER_NORMAL_PREP')
