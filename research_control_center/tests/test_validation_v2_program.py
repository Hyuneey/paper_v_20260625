...
class ValidationV2ProgramTests(unittest.TestCase):
    def test_program_state_preserves_v1_and_held_out_boundary(self) -> None:
        ...
        self.assertEqual(state['program_status'],'BINDING_APPROVED_EXECUTION_INTEGRATION_PENDING')
        ...
        self.assertEqual(state['decision_gates']['DG-03C'],'NOT_READY_EVIDENCE_PENDING')
