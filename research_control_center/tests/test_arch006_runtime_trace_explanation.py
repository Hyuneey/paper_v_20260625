...
class Arch006RuntimeTraceExplanationTests(unittest.TestCase):
    ...
    def test_state_dashboard_and_summary(self):
        ...
        self.assertIn(state["last_completed_task"], {"ARCH-006", "ARCH-007", "ARCH-008", "ARCH-009"})
        self.assertTrue(state["exact_next_task"].startswith(("ARCH-007", "ARCH-008", "ARCH-009", "ARCH-010")))
        ...
        self.assertTrue("ARCH-007" in summary or "ARCH-008" in summary or "ARCH-009" in summary or "ARCH-010" in summary)
