...
class Arch006RuntimeTraceExplanationTests(unittest.TestCase):
    ...
    def test_state_dashboard_and_summary(self):
        ...
        self.assertTrue(state["last_completed_task"] in {"ARCH-006", "ARCH-007", "ARCH-008", "ARCH-009", "ARCH-010", "GAP-000", "ARCH-011"} or state["last_completed_task"].startswith(("GAP-FIX-001", "GAP-FIX-002")))
        self.assertTrue(state["exact_next_task"].startswith(("ARCH-007", "ARCH-008", "ARCH-009", "ARCH-010", "GAP-000", "ARCH-011", "GAP-FIX-001", "GAP-FIX-002", "V2-PROTOCOL-001")))
        ...
        self.assertTrue("ARCH-007" in summary or "ARCH-008" in summary or "ARCH-009" in summary or "ARCH-010" in summary or "GAP-000" in summary or "ARCH-011" in summary or "GAP-FIX-001" in summary or "GAP-FIX-002" in summary or "V2-PROTOCOL-001" in summary)
